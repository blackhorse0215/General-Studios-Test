...
function HomeProductItem({id}){
    ...
    return (
        <div id={productDetails.id} className="w-full  min-h-dvh flex justify-between max-lg:flex max-lg:flex-col">
            {
                video != "" ?
                    <div className={`${Mycontext.HomeProductId != id ? 'w-1/2 max-lg:w-full' : 'w-10% max-lg:w-full'} transition-all duration-1000 ease `}>
            ...
            <div className={`${Mycontext.HomeProductId != id ? 'w-1/2 max-lg:w-full' : 'w-90% max-lg:w-full'} transition-all duration-1000 ease border-solid border border-black `}>
